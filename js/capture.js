...
let pngSequenceCameraSnapshot = null;
...
function renderOffscreen() {
    ...
    const savedCameraSnapshot = pngSequenceCameraSnapshot ? captureCurrentCameraSnapshot() : null;
    if (pngSequenceCameraSnapshot) applyCameraSnapshot(pngSequenceCameraSnapshot);
    ...
    if (savedCameraSnapshot) applyCameraSnapshot(savedCameraSnapshot);
...
function captureCurrentCameraSnapshot() {
    return {
